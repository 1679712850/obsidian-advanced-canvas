...
import {
	...
	DEFAULT_LINE_NAMED_COLOR_ATTRIBUTES,
	DEFAULT_NODE_NAMED_COLOR_ATTRIBUTES,
	NamedColorAttribute,
	StyleAttribute
} from "./canvas-extensions/advanced-styles/style-config"
...
export interface AdvancedCanvasPluginSettings {
	...
	nodeNamedColors: NamedColorAttribute[],
	lineNamedColors: NamedColorAttribute[]
}
...
export const DEFAULT_SETTINGS: Partial<AdvancedCanvasPluginSettings> = {
	...
	nodeNamedColors: DEFAULT_NODE_NAMED_COLOR_ATTRIBUTES,
	lineNamedColors: DEFAULT_LINE_NAMED_COLOR_ATTRIBUTES
	// {name : "",color : "#000000"}
}
			...
			new Setting(defaultNodeStylesEl)
				...
				.addDropdown((dropdown) =>
					dropdown
						...
						.setValue((this.settingsManager.getSetting(settingsKey) as {
							[key: string]: string
						})[stylableAttribute.datasetKey] ?? 'null')
						.onChange(async (value) => {
