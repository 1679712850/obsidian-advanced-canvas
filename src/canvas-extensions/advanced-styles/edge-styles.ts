...
import EdgePathfindingSelfLink from "./edge-pathfinding-methods/pathfinding-self-link";
...
const EDGE_PATHFINDING_METHODS: { [key: string]: new() => EdgePathfindingMethod } = {
	...
	'self-link' : EdgePathfindingSelfLink
}
...
export default class EdgeStylesExtension extends CanvasExtension {
	...
	isEnabled() {
		return 'edgesStylingFeatureEnabled' as const
	}
