...
export default class CanvasHelper {
	...
	static createPopupMenuOption(menuOption: MenuOption): HTMLElement {
		...
		menuOptionElement.addEventListener('click', () => {
			if (menuOptionElement.id && menuOptionElement.isActiveElement()) {
				for (const index in this.activeButtons) {
					const button = this.activeButtons[index]
					button.click();
				}
				this.activeButtons = [menuOptionElement]
			}
			else {
				this.activeButtons = []
			}
	...
	static addStyleAttributesToPopup(plugin: AdvancedCanvasPlugin, canvas: Canvas, styleAttributes: StyleAttribute[], currentStyleAttributes: {
		[key: string]: string | null
	}, setStyleAttribute: (attribute: StyleAttribute, value: string | null) => void) {
	...
	static addStyleAttributesButtons(canvas: Canvas, stylableAttributes: StyleAttribute[], currentStyleAttributes: {
		[key: string]: string | null
	}, setStyleAttribute: (attribute: StyleAttribute, value: string | null) => void) {
	...
	static addStyleAttributesDropdownMenu(canvas: Canvas, stylableAttributes: StyleAttribute[], currentStyleAttributes: {
		[key: string]: string | null
	}, setStyleAttribute: (attribute: StyleAttribute, value: string | null) => void) {
